...
export type CompetitivePositioning = 
  ...
  | "Speed / Performance King"
  | "Ease of Use / UX Focus"
  | "Open Source Alternative"
  | (string & {});

export type KeyUnfairAdvantage = 
  | "Proprietary IP / Patent" 
  | "Network Effects" 
  | "Data Moat" 
  | "Regulatory Capture" 
  | "Founder Brand / Audience" 
...
export type ReportTone = 
  | "Ruthless VC (Critique)" 
  | "Strategic Advisor (Constructive)" 
  | "Technical Architect (Deep Dive)" 
  | "Sales Battlecard (Attack Points)"
  | "Journalistic / Investigative"
  | (string & {});

export type PerceivedThreatLevel = 
  | "Existential (Kill or be Killed)" 
  | "Annoying (Feature Parity)" 
  | "Irrelevant (Different Market)"
  | "Unknown / Dark Horse"
  | (string & {});
